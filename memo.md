...
>
> **Cam kết về bằng chứng:** mỗi ô trong bảng đều gắn nguồn có ngày. Cột "Trạng thái" ở §2.6 nói rõ nguồn nào **đã crawl trực tiếp**, nguồn nào **chỉ lấy qua snippet tìm kiếm** (chưa đọc được trang gốc do bị chặn 403).
...
| <a id="u4"></a>**[U4]** | TechCrunch — *Canva has increased prices for its Teams product* | 03/09/2024 | \$119.99 → **\$500/năm** (5 người, Mỹ); Úc \$39.99 AUD trọn gói → \$13.50 AUD/người/tháng; **không áp dụng cho Pro và Enterprise**; phát ngôn Canva về "early stage pricing"; quote user "biggest increases I have ever seen YoY" | [Link](https://techcrunch.com/2024/09/03/canva-has-increased-prices-for-its-teams-product/) | ✅ **đã crawl** |
| <a id="u5"></a>**[U5]** | **Hacker News #39824191** — *"Canva has acquired Affinity…"* · 333 pts · **341 comments** | 26/03/2024 | **Tệp SAU AI, nguyên văn:** PDF Canva ra ảnh raster chữ không chọn được, file phình to, không dùng được cho học thuật (giảng viên); editor *"convoluted, frankenstein's monster, browser-first"*; *"Canva seems lost in terms of what they are or want to be"*; user bỏ Adobe sang Affinity *"priced exceptionally well"*; lo bị lấy dữ liệu train AI | [Link](https://news.ycombinator.com/item?id=39824191) | ✅ **đã crawl** |
| <a id="u6"></a>**[U6]** | Reworked — *Canva Bets Big on a "Creative Operating System", Makes Affinity Free Forever* | 30/10/2025 | **260 triệu MAU** / 190 nước · **29 triệu paying seat** · **\$3.5B** ARR · **100 triệu+** giáo viên & học sinh · **850.000** tổ chức phi lợi nhuận · 3 tầng Creative OS · quote Cameron Adams · 3 segment mục tiêu | [Link](https://www.reworked.co/collaboration-productivity/canva-bets-big-on-a-creative-operating-system-makes-affinity-free-forever/) | ✅ **đã crawl** |
...
| <a id="u8"></a>**[U8]** | Fox Business — *Canva hit with backlash over 'insane' price hikes* | 09/2024 | Phản ứng cộng đồng với mức tăng tới 300% | [Link](https://www.foxbusiness.com/technology/online-graphic-design-platform-hit-backlash-over-insane-price-hikes-reach-300) | ⚠️ snippet |
| <a id="u9"></a>**[U9]** | PetaPixel — *After Unpopular Price Increase, Canva Walks Back Part of Its Plan* | **10/10/2024** | **Canva LÙI GIÁ.** Khôi phục giá cho Teams đời đầu; \$180 → \$500/năm (~178%); **"Pricing Promise"** = báo trước ≥60 ngày + điều chỉnh theo vùng; quote *"…may have felt too sudden for some, especially early adopters"* | [Link](https://petapixel.com/2024/10/10/after-unpopular-price-increase-canva-walks-back-part-of-its-plan/) | ✅ **đã crawl** |
| <a id="u10"></a>**[U10]** | MarTech — *Canva reverses price hike for loyal customers* | 14/10/2024 | Nhóm bị ảnh hưởng **chủ yếu là chủ doanh nghiệp nhỏ và giáo viên**; legacy customer được thêm thành viên miễn phí trở lại | [Link](https://martech.org/canva-reverses-price-hike-for-loyal-customers/) | ✅ **đã crawl** |
| <a id="u11"></a>**[U11]** | BusinessWire — press release gốc Magic Studio + Canva Shield | 04/10/2023 | Magic Studio, **Canva Shield** (indemnity cho enterprise), quỹ \$200M creator, \$1.7B ARR, 16M paying subs | [Link](https://www.businesswire.com/news/home/20231004078842/en/) | ⚠️ snippet (đã đối chiếu qua [[E7]](#e7)) |
| <a id="u12"></a>**[U12]** | Trustpilot — Canva reviews | 2026 | 2.3/5, ~2.645 review, 57% một sao; chủ đề: billing, refund, support | [Link](https://www.trustpilot.com/review/canva.com) | ❌ **403 — chưa đọc được** |
| <a id="u13"></a>**[U13]** | G2 — Canva Pros & Cons | 2026 | 4.7/5, ~5.810 review | [Link](https://www.g2.com/products/canva/reviews?qs=pros-and-cons) | ❌ **403 — chưa đọc được** |
| <a id="u14"></a>**[U14]** | Gartner Peer Insights — Canva Enterprise | 2026 | Review có gắn nhãn vai trò và quy mô công ty | [Link](https://www.gartner.com/reviews/product/canva-enterprise) | ❌ **403 — chưa đọc được** |
...
- **9/16 nguồn đã crawl trực tiếp** (đánh ✅), gồm toàn bộ phần quan trọng nhất: 3 thread Hacker News với **656 comment cộng lại**, trải đúng hai bên trục AI (2021 · 2024 · 2025). Trích dẫn nguyên văn trong §2 lấy từ đây, đều mở link kiểm chứng được.
- **3 nguồn bị chặn 403** ([[U12]](#u12) [[U13]](#u13) [[U14]](#u14)): Trustpilot, G2, Gartner đều chặn truy cập tự động. Số liệu review chỉ lấy qua snippet tìm kiếm, **chưa đọc trang gốc** — nên §2 **không dùng chúng làm luận cứ chính**, chỉ để tham khảo. Nếu đưa lên slide, phải mở tay ba trang này.
- **Số liệu vênh nhau, đã ghi nhận:** TechCrunch nói gói Teams từ **\$119.99** → \$500/năm [[U4]](#u4); PetaPixel nói từ **\$180** → \$500 (~178%) [[U9]](#u9). Hai nguồn lấy baseline khác nhau (5 người vs 3 người). Khi trình bày nên dùng cụm *"tăng tới ~300%"* và dẫn cả hai, đừng chốt một con số.
- **Đã loại có chủ đích:** các trang thống kê SEO (sqmagazine, amraandelma, virtualassistantva…) đưa số rất hấp dẫn — "98% Fortune 500", "tiết kiệm \$47.000/công ty/năm", "Enterprise +112% sau Q1 2026". **Không dùng.** Không truy được về press release gốc, mang dấu hiệu nội dung sinh tự động.
- **Persona Linh / Hà / Minh là tổng hợp, không phải người có thật.** Dựng từ mô tả tệp trong [[U1]](#u1) và từ phát ngôn nguyên văn của user thật trên HN [[U2]](#u2) [[U5]](#u5) [[U7]](#u7). Đây là công cụ tư duy, không phải dữ liệu phỏng vấn — nếu bị hỏi "đã phỏng vấn ai chưa" thì trả lời thẳng là **chưa**.
- **Chưa làm, nên làm nếu còn thời gian:** tự dùng free tier và ghi lại onboarding; đọc trực tiếp 20 review 1–2 sao trên Capterra để lấy quote nguyên văn; vào thẳng r/graphic_design và r/smallbusiness quanh mốc 09/2024 (Reddit chặn crawl tự động, phải mở tay).
...
- **Chỉ 1/7 nguồn §3 crawl trực tiếp được** ([^18] Forbes AU). Phần còn lại lấy qua snippet tìm kiếm — yếu hơn hẳn §2 (8/14 crawl trực tiếp). **Trước khi lên slide phải verify tay** ít nhất ba con số làm trụ cho lập luận: `\$6 tỷ ad spend` [^15], `AI Pass \$100/người/tháng` [^19], và `31,2 triệu người trả tiền` [^20].
